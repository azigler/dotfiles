---
description: Conference proposal & paper-submission orchestrator. Bootstraps a submission project at ~/cfp/<slug>/ with full discipline (beads, CLAUDE.md, refs/, research/), runs the interview-research-draft-critic-submit loop, and shepherds post-acceptance through to an accepted, archived, registered submission. Peer-reviewed venues additionally fire a scientific-paper sub-arc (revision specs, artifact bundles, arXiv). Hands off to /talk on acceptance.
