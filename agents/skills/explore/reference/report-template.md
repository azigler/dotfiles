...
3-7 bullets — if u find more than 7, u're padding.]
...
== Models / projects / sources u missed ==

[ALWAYS include this section. The user gave u N URLs. There are
...
about which angles fit ur audience and which are weaker. Don't
pitch a post u wouldn't write urself.]
...
- Address the user as "u" / "ur" — same casual register as Zig voice.
- Don't pad. Cite what u found. Leave gaps as gaps.
...
- Length: 3000-15000 chars typical. Beyond that u're probably padding;
  shorter than 2000 u probably underdid the cross-cuts.
...
## What to put in "What u should learn" vs "Possible social-post angles"

- **What u should learn** = applicability to the user's work. Their
...
- **Possible social-post angles** = the audience-facing framing. What
  would u write if u were Andrew? Always honest about which angles fit
...
- ❌ Forgetting the "u missed these" section. That section IS the value.
- ❌ Equal weighting of every source. Some sources are richer than
  others. Lean into the richest.
- ❌ Padding "what u should learn" w/ generic AI-trends commentary.
  Tie every bullet to the user's actual work.
- ❌ Suggesting social-post angles u wouldn't actually write. The user
  trusts ur taste; don't burn it w/ filler suggestions.
...
- **Talkie + Mr. Chatterbox**: Asana task 1208774875668858. Topic:
  vintage LLMs trained on pre-cutoff data. Strong "u missed these"
...
- **Open Models cluster**: Asana task 1213911980284273. Topic: April
  ...
  u missed" surfaced Qwen3 + Phi-4 + Liquid + OLMo + Granite + Nemotron.
