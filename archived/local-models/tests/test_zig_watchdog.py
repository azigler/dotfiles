...
# --- HermesGatewayJob tests REMOVED 2026-05-28 (dotfiles-lzs, Phase C-lite) ----
# The HermesGatewayJob class was the only watchdog component touching
# ~/.hermes/kanban.db from outside the gateway process. Stripped per the user
# redirect after Wave 19 (don't fight Hermes; stop being an outside writer).
# With Phase A+B caps live, the gateway doesn't need outside babysitting.
